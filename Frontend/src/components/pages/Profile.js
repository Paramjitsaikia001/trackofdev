    ...
    return (
        <section className="flex flex-col xl:w-[80%] w-[100%] h-[100%]">
            <div className="w-full flex flex-col gap-8">
                ...
                <div className="profiledetails flex flex-col relative">
                    <div className="relative pb-6">
                        <div className="header w-full relative">
                            ...
                            {/* Edit Button - Changed to button instead of Link */}
                            <button
                                onClick={handleEditProfile}
                                className="text-center profilepic text-white/80 text-md rounded-full border-2 font-bold border-white/20 py-2 px-5 absolute right-0 m-2 cursor-pointer hover:bg-white/10 transition-colors duration-200"
                            >
                ...
                {isSavedRoadmaps && <SavedRoadmaps />}
                {isReviews && <ReviewsofUser />}
                {isActivity && <UserActivity />}
            </div>
